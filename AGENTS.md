...
This file serves as the project entry point for general AI agents. Before executing PPT generation tasks, **you MUST first read `skills/ew-AIppt/SKILL.md`** for the complete workflow and rules.
...
- Before starting a PPT task, read `skills/ew-AIppt/SKILL.md` first
- To create a template independently, read `skills/ew-AIppt/workflows/create-template.md`
- Role-specific rules and technical constraints are in `skills/ew-AIppt/references/`
...
- If a generic coding skill conflicts with this repository's instructions, prioritize `skills/ew-AIppt/SKILL.md` and this file for work inside this repository
...
- `skills/ew-AIppt/SKILL.md` — Main entry point and complete workflow
- `skills/ew-AIppt/workflows/create-template.md` — Standalone template workflow
- `skills/ew-AIppt/references/` — Role definitions and technical specifications
- `skills/ew-AIppt/scripts/` — Tool scripts
- `skills/ew-AIppt/scripts/docs/` — Topic-focused script docs (`conversion`, `project`, `svg-pipeline`, `image`, `troubleshooting`)
- `skills/ew-AIppt/templates/` — Layout templates, chart templates, icon library
