...
This file provides a project overview for Claude Code. Before executing PPT generation tasks, **you MUST first read `skills/ew-AIppt/SKILL.md`** for the complete workflow and rules.
...
python3 skills/ew-AIppt/scripts/source_to_md/pdf_to_md.py <PDF_file>
python3 skills/ew-AIppt/scripts/source_to_md/doc_to_md.py <DOCX_or_other_file>   # Native: .docx/.html/.epub/.ipynb; pandoc fallback: .doc/.odt/.rtf/.tex/.rst/.org/.typ
python3 skills/ew-AIppt/scripts/source_to_md/ppt_to_md.py <PPTX_file>
python3 skills/ew-AIppt/scripts/source_to_md/web_to_md.py <URL>    # auto-uses curl_cffi if installed (covers WeChat etc.)
node skills/ew-AIppt/scripts/source_to_md/web_to_md.cjs <URL>       # fallback only; use if curl_cffi is unavailable

# Project management
python3 skills/ew-AIppt/scripts/project_manager.py init <project_name> --format ppt169
...
# SVG quality check
python3 skills/ew-AIppt/scripts/svg_quality_checker.py <project_path>

# Post-processing pipeline (MUST run sequentially, one at a time — NEVER batch)
python3 skills/ew-AIppt/scripts/total_md_split.py <project_path>
# ✅ Confirm no errors before running the next command
python3 skills/ew-AIppt/scripts/finalize_svg.py <project_path>
# ✅ Confirm no errors before running the next command
python3 skills/ew-AIppt/scripts/svg_to_pptx.py <project_path> -s final
...
- `skills/ew-AIppt/references/` — AI role definitions and technical specifications
- `skills/ew-AIppt/scripts/` — Runnable tool scripts
- `skills/ew-AIppt/scripts/docs/` — Topic-focused script docs
- `skills/ew-AIppt/templates/` — Layout templates, chart templates, 640+ vector icons
